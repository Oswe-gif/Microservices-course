...
@Tag(
        ...
        description = "CRUD REST APIs for EazyBank to create, update, fetch and delete accounts details"
)
@RestController
...
public class AccountsContactInfoDto {
    ...
    public AccountsContactInfoDto(IAccountsService accountsService) {
    ...
    @Autowired
    private com.eazybytes.accounts.dto.AccountsContactInfoDto accountsContactInfoDto;
    ...
    @Operation(
            ...
            description = "Get java version that's installed into accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    @Operation(
            ...
            description = "Contact info that can be reached out into accounts microservice"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<com.eazybytes.accounts.dto.AccountsContactInfoDto> getContactInfo(){
